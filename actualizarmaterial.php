...
<body>
    <div class="container">
        ...
        <div class="col-md-20 text-center" >
            <h3>Actualizar Registro de Material</h3>
        </div><br>
        <div class="row">
            <div class="col-md-offset-4">
                <form method="post" class="col-sm-6 panel panel-primary panel-body" action="actmaterial.php">

                    <input type="hidden" name="id" value="<?= $_GET['id'] ?>">

                    <div class="form-group">
                        <label for="exampleInputEmail1">Material:</label>
                        <input type="text" name="material" class="form-control" placeholder="Nombre del Material" value="<?= $row['material'] ?>" autocomplete="off">
                    </div>
