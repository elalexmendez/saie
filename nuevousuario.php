    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-offset-4">
                <form method="post" class="col-sm-6 panel panel-primary panel-body" action="registrousuario.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="user" class="form-control" placeholder="Apellido del Contribuyente" required autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1">Contraseña:</label>
                        <input type="text" name="pass" class="form-control" placeholder="Apellido del Contribuyente" required autocomplete="off">
                    </div>
