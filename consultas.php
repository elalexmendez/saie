            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="ingresos.html"> <i class="fa fa-sign-in"></i> Ingresos</a>
                        </li>
                        <li>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 ">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <a class="btn btn-primary" href="consdinero.php" role="button">Dinero</a>
                    </div>
                </div>
            ...
            <div class="col-sm-4 ">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                       <a class="btn btn-primary" href="consmateriales.php" role="button">Materiales</a> 
                    </div>
                </div>
            </div>
