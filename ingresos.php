         ...
         <div class="row">
            ...
            <div class="col-sm-4 ">
                <div class="thumbnail panel-primary">
                    ...
                    <div class="caption">
                        <h3>Materiales</h3>
                        <p>Control de Ingresos de los Materiales de la Iglesia Nuestra Señora del Rosario de Aranzazu</p>
                       <a class="btn btn-primary" href="materiales.php" role="button">Materiales</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 ">
                <div class="thumbnail panel-primary">
                    ...
                    <div class="caption">
                        <h3>Alimentos</h3>
                        <p>Control de Ingresos de los Alimentos de la Iglesia Nuestra Señora del Rosario de Aranzazu</p>
                        <a class="btn btn-primary" href="alimentos.php" role="button">Alimentos</a> 
                    </div>
                </div>
            </div>
