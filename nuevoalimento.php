...
<body>
    <div class="container">
        ...
        <div class="col-md-20 text-center" >
            <h3>Registro de Alimento</h3>
        </div><br>
        <div class="row">
            <div class="col-md-offset-4">
                <form method="post" class="col-sm-6 panel panel-primary panel-body" action="registroalimento.php">

                    <div class="form-group">
                        <label for="exampleInputEmail1">Alimento:</label>
                        <input type="text" name="alimento" class="form-control" placeholder="Nombre del Alimento" required autocomplete="off">
                    </div>
