...
<?php
    ...
    if(isset($_GET['id'])){
        ...
        $sql = "SELECT *, a.cantidad as cant, ali.cantidad as total FROM egresos e JOIN egresos_alimentos a ON a.egreso_id = e.id JOIN alimentos ali on ali.id = a.alimento_id WHERE e.id = " . $id;
                ...
                <div class="col-sm-4 ">
                    <div class="panel panel-primary panel-body">
                        <div class="form-group">
                            ...
                            <input disabled id="ci" type="text" name="cedula" class="form-control" placeholder="Cedula" required value="<?= $data['titulo'] ?>">
                        </div>
                        <div class="form-group">
