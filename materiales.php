...
<body>
    <div class="container">
        ...
        <form method="post" class="col-sm-4" action="material.php">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="span4" name="descripcion" cols="46" rows="5"  placeholder="Descripción del Material" ></textarea>
            </div>
            <button type="submit" name="enviar" class="btn btn-default">Ingresar</button>
        </form>
    </div>
