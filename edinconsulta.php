...
<body>
    <div class="container">
        ...
        <div class="row">
            <h2 class="col-sm-11">Consultas sobre Egresos de Dinero</h2>
            <div class="col-sm-4 ">
                <div class="thumbnail panel-primary">
                    <img src="assets/images/dinero.jpg" alt="...">
                    <div class="caption">
                        <p>Consulta por Fecha</p>
                        <a class="btn btn-primary" href="efechadinero.php" role="button">ir</a>
                    </div>
                </div>
            ...
            <div class="col-sm-4 ">
                <div class="thumbnail panel-primary">
                    <img src="assets/images/dinero.jpg" alt="...">
                    <div class="caption">
                        <p>Consulta acerca de Historial de Egresos</p>
                        <a class="btn btn-primary" href="ehistdinero.php" role="button">ir</a> 
                    </div>
                </div>
            </div>
