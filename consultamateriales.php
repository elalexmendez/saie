...
<body>
    <div class="container">
        ...
        <div class="col-md-20 text-center">
                <h3>Consultas por Fecha de Ingresos de Materiales</h3>
            </div>
            <br>
            <div class="row">
                <div class="col-md-offset-4">
                    <form method="post" class="col-sm-6 panel panel-primary panel-body" action="resultadomateriales.php">
        ...
        <div class="col-md-20 text-center">
            <div class="row">
                <div class="row col-md-4 col-md-offset-4 custyle">
                    <a href="histmateriales.php" role="button">
                            <div class="thumbnail panel-primary">
                                <div class="caption">
                                    <h3>Historial de Ingresos de Materiales</h3>
                        </div></a>
                </div>
            </div>
        </div>
